        ...
        public class Cutout
        {
            ...
            public class Standard
            {
              public  class IDs
                ...
                public static IDs[] _ids = new IDs[] { new IDs(0), new IDs(1), new IDs(2), new IDs(3), new IDs(4) };
                    ...
                    switch (property)
                    {
                        case Property.Clip:
                            if (type == typeof(float))
                                material.SetFloat(_ids[0].clip, (float)value);
                            break;
                        case Property.Map1:
                            if (value == null)
                                material.SetTexture(_ids[0].map1, null);
                            else if (type == typeof(Texture2D))
                                material.SetTexture(_ids[0].map1, (Texture2D)value);
                            else if (type == typeof(Texture))
                                material.SetTexture(_ids[0].map1, (Texture)value);
                            break;
                        case Property.Map1Tiling:
                            if (type == typeof(Vector3))
                                material.SetVector(_ids[0].map1Tiling, (Vector3)value);
                            break;
                        case Property.Map1Offset:
                            if (type == typeof(Vector3))
                                material.SetVector(_ids[0].map1Offset, (Vector3)value);
                            break;
                        case Property.Map1Scroll:
                            if (type == typeof(Vector3))
                                material.SetVector(_ids[0].map1Scroll, (Vector3)value);
                            break;
                        case Property.Map1Intensity:
                            if (type == typeof(float))
                                material.SetFloat(_ids[0].map1Intensity, (float)value);
                            break;
                        case Property.Map1Channel:
                            if (type == typeof(MapChannel))
                                material.SetInt(_ids[0].map1Channel, (int)value);
                            break;
                        case Property.Map1Invert:
                            if (type == typeof(bool))
                                material.SetInt(_ids[0].map1Invert, (bool)value ? 1 : 0);
                            break;
                        case Property.Map2:
                            if (value == null)
                                material.SetTexture(_ids[0].map2, null);
                            else if (type == typeof(Texture2D))
                                material.SetTexture(_ids[0].map2, (Texture2D)value);
                            else if (type == typeof(Texture))
                                material.SetTexture(_ids[0].map2, (Texture)value);
                            break;
                        case Property.Map2Tiling:
                            if (type == typeof(Vector3))
                                material.SetVector(_ids[0].map2Tiling, (Vector3)value);
                            break;
                        case Property.Map2Offset:
                            if (type == typeof(Vector3))
                                material.SetVector(_ids[0].map2Offset, (Vector3)value);
                            break;
                        case Property.Map2Scroll:
                            if (type == typeof(Vector3))
                                material.SetVector(_ids[0].map2Scroll, (Vector3)value);
                            break;
                        case Property.Map2Intensity:
                            if (type == typeof(float))
                                material.SetFloat(_ids[0].map2Intensity, (float)value);
                            break;
                        case Property.Map2Channel:
                            if (type == typeof(MapChannel))
                                material.SetInt(_ids[0].map2Channel, (int)value);
                            break;
                        case Property.Map2Invert:
                            if (type == typeof(bool))
                                material.SetInt(_ids[0].map2Invert, (bool)value ? 1 : 0);
                            break;
                        case Property.Map3:
                            if (value == null)
                                material.SetTexture(_ids[0].map3, null);
                            else if (type == typeof(Texture2D))
                                material.SetTexture(_ids[0].map3, (Texture2D)value);
                            else if (type == typeof(Texture))
                                material.SetTexture(_ids[0].map3, (Texture)value);
                            break;
                        case Property.Map3Tiling:
                            if (type == typeof(Vector3))
                                material.SetVector(_ids[0].map3Tiling, (Vector3)value);
                            break;
                        case Property.Map3Offset:
                            if (type == typeof(Vector3))
                                material.SetVector(_ids[0].map3Offset, (Vector3)value);
                            break;
                        case Property.Map3Scroll:
                            if (type == typeof(Vector3))
                                material.SetVector(_ids[0].map3Scroll, (Vector3)value);
                            break;
                        case Property.Map3Intensity:
                            if (type == typeof(float))
                                material.SetFloat(_ids[0].map3Intensity, (float)value);
                            break;
                        case Property.Map3Channel:
                            if (type == typeof(MapChannel))
                                material.SetInt(_ids[0].map3Channel, (int)value);
                            break;
                        case Property.Map3Invert:
                            if (type == typeof(bool))
                                material.SetInt(_ids[0].map3Invert, (bool)value ? 1 : 0);
                            break;
                        case Property.MapsBlendType:
                            if (type == typeof(MapsBlendType))
                                material.SetInt(_ids[0].mapsBlendType, (int)value);
                            break;
                        case Property.TriplanarMappingSpace:
                            if (type == typeof(TriplanarMappingSpace))
                                material.SetInt(_ids[0].mapsTriplanarMappingSpace, (int)value);
                            break;
                        case Property.ScreenSpaceUVScale:
                            if (type == typeof(ScreenSpaceUVScale))
                                material.SetInt(_ids[0].mapsScreenSpaceUVScale, (int)value);
                            break;
                        case Property.BaseInvert:
                            if (type == typeof(bool))
                                material.SetInt(_ids[0].baseInvert, (bool)value ? 1 : 0);
                            break;
                        default:
                            break;
                    }
                ...
                static public void UpdateGlobalProperty(AdvancedDissolve.AdvancedDissolveKeywords.GlobalControlID globalControlID, Property property, object value)
                {
                    ...
                    switch (property)
                    {
                        case Property.Clip:
                            if (type == typeof(float))
                                Shader.SetGlobalFloat(_ids[(int)globalControlID].clip, (float)value);
                            break;
                        case Property.Map1:
                            if (value == null)
                                Shader.SetGlobalTexture(_ids[(int)globalControlID].map1, null);
                            else if (type == typeof(Texture2D))
                                Shader.SetGlobalTexture(_ids[(int)globalControlID].map1, (Texture2D)value);
                            else if (type == typeof(Texture))
                                Shader.SetGlobalTexture(_ids[(int)globalControlID].map1, (Texture)value);
                            break;
                        case Property.Map1Tiling:
                            if (type == typeof(Vector3))
                                Shader.SetGlobalVector(_ids[(int)globalControlID].map1Tiling, (Vector3)value);
                            break;
                        case Property.Map1Offset:
                            if (type == typeof(Vector3))
                                Shader.SetGlobalVector(_ids[(int)globalControlID].map1Offset, (Vector3)value);
                            break;
                        case Property.Map1Scroll:
                            if (type == typeof(Vector3))
                                Shader.SetGlobalVector(_ids[(int)globalControlID].map1Scroll, (Vector3)value);
                            break;
                        case Property.Map1Intensity:
                            if (type == typeof(float))
                                Shader.SetGlobalFloat(_ids[(int)globalControlID].map1Intensity, (float)value);
                            break;
                        case Property.Map1Channel:
                            if (type == typeof(MapChannel))
                                Shader.SetGlobalInt(_ids[(int)globalControlID].map1Channel, (int)value);
                            break;
                        case Property.Map1Invert:
                            if (type == typeof(bool))
                                Shader.SetGlobalInt(_ids[(int)globalControlID].map1Invert, (bool)value ? 1 : 0);
                            break;
                        case Property.Map2:
                            if (value == null)
                                Shader.SetGlobalTexture(_ids[(int)globalControlID].map2, null);
                            else if (type == typeof(Texture2D))
                                Shader.SetGlobalTexture(_ids[(int)globalControlID].map2, (Texture2D)value);
                            else if (type == typeof(Texture))
                                Shader.SetGlobalTexture(_ids[(int)globalControlID].map2, (Texture)value);
                            break;
                        case Property.Map2Tiling:
                            if (type == typeof(Vector3))
                                Shader.SetGlobalVector(_ids[(int)globalControlID].map2Tiling, (Vector3)value);
                            break;
                        case Property.Map2Offset:
                            if (type == typeof(Vector3))
                                Shader.SetGlobalVector(_ids[(int)globalControlID].map2Offset, (Vector3)value);
                            break;
                        case Property.Map2Scroll:
                            if (type == typeof(Vector3))
                                Shader.SetGlobalVector(_ids[(int)globalControlID].map2Scroll, (Vector3)value);
                            break;
                        case Property.Map2Intensity:
                            if (type == typeof(float))
                                Shader.SetGlobalFloat(_ids[(int)globalControlID].map2Intensity, (float)value);
                            break;
                        case Property.Map2Channel:
                            if (type == typeof(MapChannel))
                                Shader.SetGlobalInt(_ids[(int)globalControlID].map2Channel, (int)value);
                            break;
                        case Property.Map2Invert:
                            if (type == typeof(bool))
                                Shader.SetGlobalInt(_ids[(int)globalControlID].map2Invert, (bool)value ? 1 : 0);
                            break;
                        case Property.Map3:
                            if (value == null)
                                Shader.SetGlobalTexture(_ids[(int)globalControlID].map3, null);
                            else if (type == typeof(Texture2D))
                                Shader.SetGlobalTexture(_ids[(int)globalControlID].map3, (Texture2D)value);
                            else if (type == typeof(Texture))
                                Shader.SetGlobalTexture(_ids[(int)globalControlID].map3, (Texture)value);
                            break;
                        case Property.Map3Tiling:
                            if (type == typeof(Vector3))
                                Shader.SetGlobalVector(_ids[(int)globalControlID].map3Tiling, (Vector3)value);
                            break;
                        case Property.Map3Offset:
                            if (type == typeof(Vector3))
                                Shader.SetGlobalVector(_ids[(int)globalControlID].map3Offset, (Vector3)value);
                            break;
                        case Property.Map3Scroll:
                            if (type == typeof(Vector3))
                                Shader.SetGlobalVector(_ids[(int)globalControlID].map3Scroll, (Vector3)value);
                            break;
                        case Property.Map3Intensity:
                            if (type == typeof(float))
                                Shader.SetGlobalFloat(_ids[(int)globalControlID].map3Intensity, (float)value);
                            break;
                        case Property.Map3Channel:
                            if (type == typeof(MapChannel))
                                Shader.SetGlobalInt(_ids[(int)globalControlID].map3Channel, (int)value);
                            break;
                        case Property.Map3Invert:
                            if (type == typeof(bool))
                                Shader.SetGlobalInt(_ids[(int)globalControlID].map3Invert, (bool)value ? 1 : 0);
                            break;
                        case Property.MapsBlendType:
                            if (type == typeof(MapsBlendType))
                                Shader.SetGlobalInt(_ids[(int)globalControlID].mapsBlendType, (int)value);
                            break;
                        case Property.TriplanarMappingSpace:
                            if (type == typeof(TriplanarMappingSpace))
                                Shader.SetGlobalInt(_ids[(int)globalControlID].mapsTriplanarMappingSpace, (int)value);
                            break;
                        case Property.ScreenSpaceUVScale:
                            if (type == typeof(ScreenSpaceUVScale))
                                Shader.SetGlobalInt(_ids[(int)globalControlID].mapsScreenSpaceUVScale, (int)value);
                            break;
                        case Property.BaseInvert:
                            if (type == typeof(bool))
                                Shader.SetGlobalInt(_ids[(int)globalControlID].baseInvert, (bool)value ? 1 : 0);
                            break;
                        default:
                            break;
                    }
