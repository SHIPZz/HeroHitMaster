...
{
    public class PlayerShootState : IInitializable, IDisposable
    {
        ...
        public PlayerShootState(PlayerShootInput playerShootInput, PlayerShoot playerShoot,
            PlayerAnimator playerAnimator,
            IProvider<Weapon> weaponProvider, 
