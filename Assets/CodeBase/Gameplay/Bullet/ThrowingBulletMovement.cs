...
//
//             SetMove(target, startPosition, direction, MoveDuration);
//             
//             Rotate(_throwingBullet, RotateDuration);
//         }
//
//         private void SetMove(Vector3 target, Vector3 startPosition, Vector3 direction,
//             float moveDuration)
//         {
//             transform.forward = direction;
//             transform.position = startPosition;
//             RigidBody.AddTorque(direction * 50);
//         }
//
//         private void Rotate(ThrowingBullet throwingBullet, float rotateDuration)
//         {
