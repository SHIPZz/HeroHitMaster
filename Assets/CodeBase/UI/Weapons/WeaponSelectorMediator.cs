...
{
    class WeaponSelectorMediator : IInitializable, IDisposable
    {
        ...
        public WeaponSelectorMediator(WeaponIconsProvider weaponIconsProvider, 
        ...
        {
            _popupInfoView.LastWeaponSelected += _weaponSelector.SetPopupWeapon;
